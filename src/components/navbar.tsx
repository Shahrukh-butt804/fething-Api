                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="md:flex md:items-center md:gap-12">
                            ...
                            <div className="hidden md:relative md:block">
                                ...
                                <div className={`${isVisible ? "block" : "hidden"} absolute end-0 z-10 mt-0.5 w-56 divide-y divide-gray-100 rounded-md border border-gray-100 bg-white shadow-lg`} role="menu">
                                    <div className="p-2">
